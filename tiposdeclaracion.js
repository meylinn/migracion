...
const nombre = "Meylin";
const apellidoPaterno = "Parrales";
const apellidoMaterno = "Aguilar";
var edad = 17;
const lugarNacimiento = "Heredia";
...
const marca = "Toyota";
const paisOrigen = "Japón";
const anio = 2010;
//Impresión de la característica de un coche
